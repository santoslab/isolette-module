...
//   $SIREUM_HOME/bin/mill isolette.run
//
// To run the example unit tests:
//   $SIREUM_HOME/bin/mill isolette.tests
//
// Sireum IVE:
...
//
//     $SIREUM_HOME/bin/mill -w isolette.tests.compile
//
// Visual Studio Code:
...
object `isolette` extends slangEmbeddedProject
...
trait SlangEmbeddedModule extends ScalaModule {
  ...
  override def mainClass = T { Some("isolette.Demo") }
...
trait slangEmbeddedInspectorProject extends slangEmbeddedProject {
  ...
  override def mainClass = T { Some("isolette.InspectorDemo") }
