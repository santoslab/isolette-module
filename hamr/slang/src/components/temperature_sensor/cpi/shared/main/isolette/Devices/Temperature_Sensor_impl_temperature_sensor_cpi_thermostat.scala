...
object Temperature_Sensor_impl_temperature_sensor_cpi_thermostat {
  ...
  def initialise(api: Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_Initialization_Api): Unit = {
  ...
  def timeTriggered(api: Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_Operational_Api): Unit = {
  ...
  def activate(api: Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_Api): Unit = { }

  def deactivate(api: Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_Api): Unit = { }

  def finalise(api: Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_Api): Unit = { }

  def recover(api: Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_Api): Unit = { }
}
