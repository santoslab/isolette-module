...
@sig trait Heat_Source_impl_heat_source_cpi_heat_controller_Api {
  def id: Art.BridgeId
...
@datatype class Heat_Source_impl_heat_source_cpi_heat_controller_Initialization_Api (
  val id: Art.BridgeId,
  val heat_control_Id : Art.PortId,
  val heat_out_Id : Art.PortId) extends Heat_Source_impl_heat_source_cpi_heat_controller_Api

@datatype class Heat_Source_impl_heat_source_cpi_heat_controller_Operational_Api (
  val id: Art.BridgeId,
  val heat_control_Id : Art.PortId,
  val heat_out_Id : Art.PortId) extends Heat_Source_impl_heat_source_cpi_heat_controller_Api {
