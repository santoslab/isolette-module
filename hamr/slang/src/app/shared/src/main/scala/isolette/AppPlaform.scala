...
object AppPlatform {
  ...
  @record class Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_EntryPointsImpl extends isolette.Regulate.Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_EntryPointsSig {
    def timeTriggered(api: isolette.Regulate.Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_Operational_Api): Unit = {
      isolette.Regulate.Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source.timeTriggered(api)
    }

    def activate(api: isolette.Regulate.Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_Operational_Api): Unit = {
      isolette.Regulate.Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source.activate(api)
    }

    def deactivate(api: isolette.Regulate.Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_Operational_Api): Unit = {
      isolette.Regulate.Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source.deactivate(api)
    }

    def finalise(api: isolette.Regulate.Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_Operational_Api): Unit = {
      isolette.Regulate.Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source.finalise(api)
    }

    def initialise(api: isolette.Regulate.Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_Initialization_Api): Unit = {
      isolette.Regulate.Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source.initialise(api)
    }

    def recover(api: isolette.Regulate.Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_Operational_Api): Unit = {
  ...
  @record class Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_EntryPointsImpl extends isolette.Monitor.Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_EntryPointsSig {
    def timeTriggered(api: isolette.Monitor.Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Operational_Api): Unit = {
      isolette.Monitor.Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm.timeTriggered(api)
    }

    def activate(api: isolette.Monitor.Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Operational_Api): Unit = {
      isolette.Monitor.Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm.activate(api)
    }

    def deactivate(api: isolette.Monitor.Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Operational_Api): Unit = {
      isolette.Monitor.Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm.deactivate(api)
    }

    def finalise(api: isolette.Monitor.Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Operational_Api): Unit = {
      isolette.Monitor.Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm.finalise(api)
    }

    def initialise(api: isolette.Monitor.Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Initialization_Api): Unit = {
      isolette.Monitor.Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm.initialise(api)
    }

    def recover(api: isolette.Monitor.Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Operational_Api): Unit = {
  ...
  @record class Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_EntryPointsImpl extends isolette.Monitor.Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_EntryPointsSig {
    def timeTriggered(api: isolette.Monitor.Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_Operational_Api): Unit = {
      isolette.Monitor.Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode.timeTriggered(api)
    }

    def activate(api: isolette.Monitor.Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_Operational_Api): Unit = {
      isolette.Monitor.Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode.activate(api)
    }

    def deactivate(api: isolette.Monitor.Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_Operational_Api): Unit = {
      isolette.Monitor.Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode.deactivate(api)
    }

    def finalise(api: isolette.Monitor.Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_Operational_Api): Unit = {
      isolette.Monitor.Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode.finalise(api)
    }

    def initialise(api: isolette.Monitor.Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_Initialization_Api): Unit = {
      isolette.Monitor.Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode.initialise(api)
    }

    def recover(api: isolette.Monitor.Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_Operational_Api): Unit = {
  ...
  @record class Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_EntryPointsImpl extends isolette.Devices.Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_EntryPointsSig {
    def timeTriggered(api: isolette.Devices.Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_Operational_Api): Unit = {
      isolette.Devices.Temperature_Sensor_impl_temperature_sensor_cpi_thermostat.timeTriggered(api)
    }

    def activate(api: isolette.Devices.Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_Operational_Api): Unit = {
      isolette.Devices.Temperature_Sensor_impl_temperature_sensor_cpi_thermostat.activate(api)
    }

    def deactivate(api: isolette.Devices.Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_Operational_Api): Unit = {
      isolette.Devices.Temperature_Sensor_impl_temperature_sensor_cpi_thermostat.deactivate(api)
    }

    def finalise(api: isolette.Devices.Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_Operational_Api): Unit = {
      isolette.Devices.Temperature_Sensor_impl_temperature_sensor_cpi_thermostat.finalise(api)
    }

    def initialise(api: isolette.Devices.Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_Initialization_Api): Unit = {
      isolette.Devices.Temperature_Sensor_impl_temperature_sensor_cpi_thermostat.initialise(api)
    }

    def recover(api: isolette.Devices.Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_Operational_Api): Unit = {
