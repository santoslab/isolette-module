...
Unit isolette_Isolette_UserInterface_Interface_finalise(STACK_FRAME_ONLY) {
  // do nothing 
}

Unit isolette_Isolette_UserInterface_Interface_initialise(STACK_FRAME 
  ...
  printf("isolette_Isolette_UserInterface_Interface_initialise called \n");
