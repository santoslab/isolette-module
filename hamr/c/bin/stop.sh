...
#
APPS="Demo Manage_Regulator_Interface_impl_thermostat_regulate_temperature_manage_regulator_interface_App Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_App Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_App Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_App Manage_Monitor_Interface_impl_thermostat_monitor_temperature_manage_monitor_interface_App Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_App operator_interface_thread_impl_operator_interface_oip_oit_App Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_App Heat_Source_impl_heat_source_cpi_heat_controller_App"
for APP in ${APPS}; do
  pkill -f -SIGTERM $APP
done
ME=`whoami`
